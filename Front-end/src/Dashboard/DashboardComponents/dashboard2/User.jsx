    ...
    <div>
      <Menu isOpen={isOpen}>
        ...
        <MenuList onMouseEnter={onOpen} onMouseLeave={onClose}>
          <MenuItem><Flex gap="0.5rem"><FaRegUser size={"1.3rem"} />{user.email}</Flex></MenuItem>
          <MenuDivider />
          <MenuItem>
          ...
          <MenuDivider />
          <MenuItem><Flex gap="0.5rem" onClick={handleSignout}><ImSwitch size={"1.3rem"} />Logout</Flex></MenuItem>
        </MenuList>
      </Menu>
    </div>
  )
