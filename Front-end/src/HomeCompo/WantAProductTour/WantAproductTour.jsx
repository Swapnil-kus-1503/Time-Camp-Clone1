        ...
        <div>
            ...
            <SimpleGrid columns={["1", "1", "2"]} minH="438px" bg={"#1B1B20"}>
                <Flex direction={"column"} gap="10" p={["4", "7", "12", "16"]}>
                    ...
                    <Text color={"white"} fontSize={"xl"}>Learn all the tracking basics of TimeCamp and track time like a true pro</Text>
                    <Button w={["90%", "60%", "40%"]} bg={"#F7B801"} color="white" borderRadius={"full"} size={"lg"}>Book a Demo</Button>
                </Flex>
                <Image  w={["100%","95%", "90%"]} h={["220px", "360px", "450px"]} src='https://cdn-m.timecamp.com/img/greenbranding/features/black_cta_img-platform.png'></Image>
            </SimpleGrid>
