          ...
          <Box>
            <AccordionItem minH={"100%"}>
              <AccordionButton>
                ...
                >
                  <Box minH={"60px"} dis>
                    <Heading fontSize={"xl"}>What is time tracker</Heading>
                  </Box>
                  <AccordionIcon />
                </Flex>
              </AccordionButton>
              ...
              <AccordionPanel pb={4}>
                <Text>
                  ...
                  tasks and projects. It
                </Text>
                <Text>
                  is used in many industries (law firms, accounting, creative
                  agencies, IT teams) for settling up with hourly workers and
          ...
          <Box>
            <AccordionItem minH={"100%"}>
              <AccordionButton>
                ...
                >
                  <Box minH={"60px"} dis>
                    <Heading fontSize={"xl"}>Why use time tracker</Heading>
                  </Box>
                  <AccordionIcon />
                </Flex>
              </AccordionButton>
              ...
              <AccordionPanel pb={4}>
                ...
                <Text>
                  1.<b>Tracking billable hours:</b> helps freelancers and
                  employees who are paid on an hourly basis measure time spent
                  on work with accuracy up to every second.
                </Text>
                <Text>
                  2.<b>Improving productivity:</b> employees who struggle with
                  poor time management and distractions can work on their
                  efficiency, understand how they work, and what takes most of
                  their time.
                </Text>
                <Text>
                  3.<b>Timesheet management:</b>one of the most common features
                  of time tracker is a timesheet – a digital version of a paper
                  timesheet. With a time tracker, your team can have it filled
                  out automatically.
                </Text>
                <Text>
                  4.<b>Work automation:</b>time tracker helps to save time on
            ...
            <AccordionItem minH={"100%"}>
              ...
              <AccordionPanel pb={4}>
                ...
                <Text>
                  ...
                  the time tracker collects all the data for timesheets. Edit
                  your time logs any time or add time manually for even more
                  accuracy. Approve your team’s daily or weekly timesheets with
                  one click without effort. Quick, easy, and painless timesheet
                  management!
                </Text>
              </AccordionPanel>
            </AccordionItem>
