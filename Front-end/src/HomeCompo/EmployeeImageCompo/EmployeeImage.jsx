    ...
    return (
        <div>
            ...
            <Box bg={"#25cf60"} pt={"20px"}>
                ...
                <Flex pb={"0.5rem"} justify={"space-between"} direction={{ base: 'column', sm: 'column', md: 'column', lg: 'row' }} w={{ base: '100%', sm: '100%', md: '100%', lg: '80%' }}>

                    <Box textAlign={"center"} display="flex" justifyContent={"center"} position={"relative"} minH="1px" >
