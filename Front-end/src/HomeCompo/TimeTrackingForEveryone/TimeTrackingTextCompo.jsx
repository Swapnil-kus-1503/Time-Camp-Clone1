...
function TimeTrackingTextCompo({ forwhome, firstHeading, secondHeading, thirdHeading, littledes, fourthHeading, largestdes, btnText }) {
    return (
        <Flex direction={"column"} gap="6" w={"90%"} >

            <Text fontWeight={"medium"} color={"#25CF60"}>{forwhome}</Text>
            <Box>
