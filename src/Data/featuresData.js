export const dataa = {
  ...
  reporting: {
    ...
    QuickLook: {
      ...
      oneDes: "The most insightful build-in reports.",
      two: "Custom built reports",
      twoDes: "Define and create new reports to match your own needs.",
      three: "Easy sharing",
      threeDes: "Export and share as PDF, Excel or via e-mail.",
      four: "Invite guests",
      fourDes: "Invite clients are show how their project perform.",
    },
    features: {
      one: "10+ build-in report types",
      oneDes:
  ...
  "productivity-tracking": {
    ...
    QuickLook: {
      ...
      oneDes: "Precisely track time spent on apps. websites and documents.",
  ...
  "rapid-timesheet-approvals": {
    ...
    QuickLook: {
      ...
      oneDes: "Easy to submit and approve. Any time.",
      two: "Comments and feedback",
      twoDes: "Discuss current timesheets when necessary",
      three: "Automatic approvals and reminders",
      threeDes: "To keep you focused on work, not on mundane tasks.",
      four: "Lock the timesheets",
      fourDes: "Make sure that no data was changed after granting approval.",
    },
    features: {
      one: "Daily and weekly approvals",
      oneDes: "Approve your team's timesheets at any given period.",
      oneImg:
  ...
  invoicing: {
    ...
    QuickLook: {
      ...
      oneDes: "Feed timesheet data into precise and transparent invoices.",
      two: "Adjustable tax rates",
      twoDes: "Set up tax rates that are applicable in your country.",
      ...
      fourDes: "To keep you focused on work, not on mundane tasks.",
    },
    features: {
      ...
      twoDes: "Add tax rates relevant to current and local regulations",
      twoImg:
