    ...
    <div>
      <Menu isOpen={isOpen}>
        ...
        <MenuList onMouseEnter={onOpen} onMouseLeave={onClose}>
          ...
          <MenuItem>
            <a
              href="https://timecamp.s3.amazonaws.com/downloadsoft/1.7.2.0/TimeCampSetup_Win.exe"
              target="blank"
            >
              <Flex gap="0.5rem">
          ...
          <MenuDivider />
          <MenuItem>
            <Flex gap="0.5rem" onClick={handleSignout}>
              <ImSwitch size={"1.3rem"} />
              Logout
            </Flex>
          </MenuItem>
        </MenuList>
